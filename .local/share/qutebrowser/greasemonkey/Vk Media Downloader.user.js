...
var parseAJAXHeaders = __webpack_require__(57)
var parseAJAXResponse = __webpack_require__(58)
...
function makeRequest(options, useGM = false) {
  ...
  var onLoad = function (e) {
    ...
    try {
      response.data = parseAJAXResponse({
        responseText: isText && !isGM ? req.responseText : req.response,
        headers: response.headers,
        responseType: req.responseType,
      })
    } catch (error) {
      logger.error(time(), 'makeRequest error parsing response', error, response)
      response.data = isText && !isGM ? req.responseText : req.response
    }
  ...
  var onError = function (e) {
    ...
    logger.error(time(), 'makeRequest error', details.method, details.url, req.status, req.readyState, isGM, useGM)
    response.status = req.status
...
var settingsOptions = __webpack_require__(54)
var settingsTabs = __webpack_require__(56)
...
var eventEmitter = __webpack_require__(2)
var serialize = __webpack_require__(45)
...
var LOGGER = Object.keys(console).reduce(function (acc, key) {
  acc[key] = function () {
    if (BUFFER[key]) {
...
var info = __webpack_require__(9)
var eventEmitter = __webpack_require__(2)
var isEqual = __webpack_require__(26)
var logger = __webpack_require__(0)
var time = __webpack_require__(1)
...
var toUrlEncoded = __webpack_require__(27)
var logger = __webpack_require__(0)
var time = __webpack_require__(1)
...
var random = __webpack_require__(19)
var getTextAreaValue = __webpack_require__(60)
var hlsController = __webpack_require__(28)
var downloadManager = __webpack_require__(31)
var smartSize = __webpack_require__(8)
var deepCopy = __webpack_require__(6)
var normalizeFilename = __webpack_require__(32)
var copyTextToClipboard = __webpack_require__(77)
var Logger = __webpack_require__(13)
...
var audioController = {
  ...
  fetchSizeMP3: function (url, full_id) {
    return makeRequest({
      ...
      return audioController.parseSize(response)
    })
  },
  /**
   * @param {string} url
...
var makeRequest = __webpack_require__(4)
var delay = __webpack_require__(5)
var FFmpeg = __webpack_require__(70)
var Queue = __webpack_require__(29)
var localforage = __webpack_require__(71)
var requestWorker = __webpack_require__(72)
var createWorker = __webpack_require__(73)
var workerFunc = __webpack_require__(74)
var path = __webpack_require__(75)
var fetchImage = __webpack_require__(76)
var base64ToUint8Array = __webpack_require__(30)
...
var ffmpegController = {
  ...
  concat: function (data) {
    ...
    return ffmpegController.load().then(function () {
      ...
      return ffmpegController.addMetadata(`output.${data.ext}`, ffmpegController.formatMetadata(data.metadata), `output_a.${data.ext}`)
    }).then(function () {
      return ffmpegController.addCover(`output_a.${data.ext}`, data.metadata.cover_p || data.metadata.cover_s, `output_b.${data.ext}`)
    }).then(function () {
...
var deepCopy = __webpack_require__(6)
var videoTooltip = __webpack_require__(24)
var delay = __webpack_require__(5)
var iframeChannel = __webpack_require__(12)
var normalizeFilename = __webpack_require__(32)
var random = __webpack_require__(19)
...
var Hls = __webpack_require__(61)
var URLToolkit = __webpack_require__(62)
var logger = __webpack_require__(0)
var makeRequest = __webpack_require__(4)
var time = __webpack_require__(1)
var smartSize = __webpack_require__(8)
...
var alphanum = __webpack_require__(66)
var getExtension = __webpack_require__(10)
var JSZip = __webpack_require__(67)
var platform = __webpack_require__(68)
var downloadFile = __webpack_require__(16)
var base64ToUint8Array = __webpack_require__(30)
var pad = __webpack_require__(69)
var iframeChannel = __webpack_require__(12)
var delay = __webpack_require__(5)
var settingsModel = __webpack_require__(7)
var info = __webpack_require__(9)
...
var Worker = __webpack_require__(63)
...
var downloadManager = {
  ...
  XHR_download: function (details, withMetadata) {
    logger.info(time(), 'XHR_download', details.url, { withMetadata: Boolean(withMetadata) })
...
var mediaObserver = {
  ...
  activateNode: function (node) {
    ...
    var hasClass = mediaObserver.hasClass
...
var child = __webpack_require__(85)
var logger = __webpack_require__(0)
var time = __webpack_require__(1)
var Logger = __webpack_require__(13)
var settingsModel = __webpack_require__(7)
...
var i18n = __webpack_require__(3)
var DOMReady = __webpack_require__(17)
var downloadIcon = __webpack_require__(40)
var audioTooltip = __webpack_require__(43)
var videoTooltip = __webpack_require__(24)
var settingsView = __webpack_require__(50)
var modalView = __webpack_require__(52)
var iframeChannel = __webpack_require__(12)
var settingsModel = __webpack_require__(7)
var videoModel = __webpack_require__(21)
var audioController = __webpack_require__(15)
var videoController = __webpack_require__(23)
var mediaObserver = __webpack_require__(33)
var keyboardController = __webpack_require__(78)
var versionController = __webpack_require__(80)
var migrateSettings = __webpack_require__(83)
var cleanStorage = __webpack_require__(84)
var eventEmitter = __webpack_require__(2)
var eventLogger = __webpack_require__(34)
var logger = __webpack_require__(0)
var time = __webpack_require__(1)
var info = __webpack_require__(9)
...
var en = __webpack_require__(38)
var ru = __webpack_require__(39)
...
var addStyle = __webpack_require__(41)
...
var eventEmitter = __webpack_require__(2)
var logger = __webpack_require__(0)
var smartBitrate = __webpack_require__(46)
var smartSize = __webpack_require__(8)
var time = __webpack_require__(1)
var tooltip = __webpack_require__(18)
...
function smartBitrate(size, duration) {
  if (!duration || !size) {
    return '-- kbps'
  }
...
var logger = __webpack_require__(0)
var smartSize = __webpack_require__(8)
var parseSize = __webpack_require__(55)
var time = __webpack_require__(1)
var i18n = __webpack_require__(3)
...
var createDocument = __webpack_require__(59)
...
var time = __webpack_require__(1);
var mediaObserver = __webpack_require__(33);
var ariaController = __webpack_require__(79);
var audioController = __webpack_require__(15)
var Logger = __webpack_require__(13);
...
var logger = __webpack_require__(0)
var makeRequest = __webpack_require__(4)
var notificationManager = __webpack_require__(81)
var parseVersion = __webpack_require__(82)
var storage = __webpack_require__(14)
var time = __webpack_require__(1)
...
var iframeController = __webpack_require__(86)
var eventLogger = __webpack_require__(34)
var settingsModel = __webpack_require__(7)
var eventEmitter = __webpack_require__(2)
var logger = __webpack_require__(0)
